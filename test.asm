...
CLOOP   JSU3    RDREC		READ INPUT RECORD
...
E#NDFIL  LDA     EOF		INSERT END OF FILE MARKER
	STA     BUFFER
...
ZERO    WORD    0
RETADR  RESW    1
LENGTH  RESW    1D		LENGTH OF RECORD
BUFFER  RESB    4A96		4096-BYTE BUFFER AREA
.
...
RLOOP   TD      INPUT		TEST INPUT DEVICE
	...
	STCH    BUFFER,C	STORE CHARCTER IN BUFFER
	TIX     MAXLEN		LOOP UNLESS MAX LENGTH
	JLT     RLOOP	  	  HAS BEEN REACHED
EXIT    STX     LENGTH		SAVE RECORD LENGTH
	RSUB                    RETURN TO CALLER
INPUT   BYTE    X'F1A'		CODE FOR INPUT DEVICE
MAXLEN	WORD	4096
.
